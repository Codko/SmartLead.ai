...
const Footer = () => {
  ...
  return (
    ...
    >
      <div className="footer-top flex flex-col lg:flex-row items-center justify-around px-4 md:px-8 lg:px-16 pt-10 lg:pt-20">
        <div className="mb-8 lg:mb-0">
          <img src="/images/Vector.png" alt="" className="mx-auto lg:mx-0" />
        </div>
