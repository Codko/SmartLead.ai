...
const AiAgentsCards = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.set(cards[1], { rotate: 8, y: 100, opacity: 1, scale: 0.6 });
      gsap.set(cards[2], {
        rotate: -45,
        x: -200,
        y: -250,
  ...
  const cards = [
    ...
    { title: "CRM updater agent" },
  ];
  return (
    <div
      ref={containerRef}
      className="flex flex-col items-center justify-center gap-6 px-4 py-10 md:flex-row md:flex-wrap lg:gap-10"
    >
