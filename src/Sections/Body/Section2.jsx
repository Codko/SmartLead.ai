...
import Companies_logo from "../../Components/Content/Companies_logo";

const Section2 = () => {
  return (
    <div className="relative w-full min-h-screen  bg-gradient-to-l from-[#e9edfa] via-[#f2f8fc] to-[#e9edfa] ">
      <svg
        className="absolute -top-full inset-0 m-auto w-[80%] h-auto"
